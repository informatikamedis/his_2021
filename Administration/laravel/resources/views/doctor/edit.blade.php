            ...
            <form method="POST" action="{{ route('doctor.edit', $doctor) }}">
                ...
                <div class="bg-white sm:p-6">
                    ...
                    <select id="sex" name="sex" class="block w-full py-3 px-1 mt-2
                        text-gray-800 appearance-none
                        border-b-2 border-gray-100">
                        <option value="{{ $doctor->sex }}" selected require>{{ $doctor->sex }}</option>
                ...
                <div class="bg-white sm:p-6">
                    ...
                    <select id="position" name="position" class="block w-full py-3 px-1 mt-2
                        text-gray-800 appearance-none
                        border-b-2 border-gray-100">
                        <option value="{{ $doctor->position }}" selected require>{{ $doctor->position }}</option>
                ...
                <div class="bg-white sm:p-6">
                    ...
                    <select id="education" name="education" class="block w-full py-3 px-1 mt-2
                        text-gray-800 appearance-none
                        border-b-2 border-gray-100">
                        <option value="{{ $doctor->education }}" selected require>{{ $doctor->education }}</option>
